...
class Task:
    ...
    def ProcessTask(thisElfAvaiTime, thisElfProd, thisToyDuration, endOfToday):
        ...
        if actualCompleteTime < endOfToday:      # can fit in
            ...
            if actualCompleteTime.hour >= 9 and actualCompleteTime.hour < 19:  # situation 1: after 9am
                startOfToday = datetime(thisElfAvaiTime.year, thisElfAvaiTime.month, thisElfAvaiTime.day, 9,0)
                m = (actualCompleteTime - startOfToday).days * 14.0 * 60.0 # float in minutes
